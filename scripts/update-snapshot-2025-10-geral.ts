...
const POSITIONS: Array<{ position: number; name: string }> = [
  ...
  { position: 2, name: "Marcos Filho" },
  { position: 3, name: "Lucas Neves" },
  { position: 4, name: "Murilo Lazarini" },
  { position: 5, name: "Matheus Coli" },
  { position: 6, name: "Caio Nunes" },
  { position: 7, name: "Ricardo Pavani" },
  { position: 8, name: "Valter Jr (Bill)" },
  { position: 9, name: "Derek Ferreira" },
  { position: 10, name: "Hugo Basili" },
  { position: 11, name: "Rodolfo Lelis" },
  { position: 12, name: "Cury" },
  { position: 13, name: "João Victor" },
  { position: 14, name: "Igor Borges" },
  { position: 15, name: "Marcelo Ramos" },
  { position: 16, name: "Ricardo Brasil" },
  { position: 17, name: "Rafael Gonçalvez" },
  { position: 18, name: "Allan Bradley" },
  { position: 19, name: "Vinícius Di Nucci" },
  { position: 20, name: "Marcos Alvarenga" },
  { position: 21, name: "Pedro Machado (PPR)" },
  { position: 22, name: "Thiago Silva" },
  { position: 23, name: "Fred Vieira" },
  { position: 24, name: "Jorginho" },
  { position: 25, name: "Lucas Bueno" },
  { position: 26, name: "Felipe Dias" },
  { position: 27, name: "Marcos Geia" },
  { position: 28, name: "Gisiel Resende" },
  { position: 29, name: "Marcilio Fonseca" },
  { position: 30, name: "Ícaro Felter" },
  { position: 31, name: "Denis Martins" },
  { position: 32, name: "Willian Kie" },
  { position: 33, name: "Pedro Lotufo" },
  { position: 34, name: "William Correa" },
  { position: 35, name: "Flavião" },
  { position: 36, name: "Rafael Calixto" },
  { position: 37, name: "Júlio Calliero" },
  { position: 38, name: "Maurício César" },
  { position: 39, name: "Gustavo Fonseca" },
  { position: 40, name: "Paulo Solera" },
  { position: 41, name: "Paulo Magalhães" },
  { position: 42, name: "Cristiano Mafort" },
  { position: 43, name: "Maiara" },
  { position: 44, name: "Fabrício Levi Maciel" },
  { position: 45, name: "Gleidon Mineiro" },
  { position: 46, name: "Jean Querido" },
  { position: 47, name: "Marcos César Mauad" },
  { position: 48, name: "Lucas Fernandes" },
  { position: 49, name: "Eduardo Marcondes" },
  { position: 50, name: "Celso Rosa" },
  { position: 51, name: "Gabriel Pedon" },
  { position: 52, name: "Kaique Oliveira" },
  { position: 53, name: "Tiago (Tigú)" },
  { position: 54, name: "Pedro Henrique" },
  { position: 55, name: "Marcio Marcondes" },
  { position: 56, name: "Thiago Oliveira" },
  { position: 57, name: "Gustavo (DDD)" },
  { position: 58, name: "André Castilho" },
  { position: 59, name: "Lucca Bianchi" },
  { position: 60, name: "Rafael Castro" },
  { position: 61, name: "Clóvis de Paula" },
  { position: 62, name: "Denis Togoro" },
  { position: 63, name: "Enzo Victor" },
  { position: 64, name: "Bruno Dedini" },
  { position: 65, name: "Carlos Yuri" },
  { position: 66, name: "Eduardo Safady" },
  { position: 67, name: "Rodolfo Lobão" },
  ...
  { position: 72, name: "Samuel Feres" },
  { position: 73, name: "Áquila Cardoso" },
  { position: 74, name: "Paulinho" },
  { position: 75, name: "André Emídio" },
  { position: 76, name: "Felipe Favalessa" },
  { position: 77, name: "Pedro Afonso" },
  { position: 78, name: "Murilo Lorena" },
  { position: 79, name: "Ronaldo Ribeiro" },
  { position: 80, name: "Fábio da Motta" },
  { position: 81, name: "Gilson César" },
  { position: 82, name: "Enzo Uliani" },
  { position: 83, name: "Felipe Betioli" },
  { position: 84, name: "Matheus Machado" },
  { position: 85, name: "Zé Pedro" },
]
