...
const POSITIONS: Array<{ position: number; name: string }> = [
  ...
  { position: 10, name: "Rogério Botini" },
  { position: 11, name: "Rodrigo Kako" },
  { position: 12, name: "Cassiano Ricardo" },
  { position: 13, name: "Marcelo Palhares" },
  { position: 14, name: "Xuxa" },
  { position: 15, name: "Luis Gustavo" },
  { position: 16, name: "Henrique Groh" },
  { position: 17, name: "Jarô" },
  { position: 18, name: "Paulo (Mocó)" },
  { position: 19, name: "Iuri Pinheiro" },
  { position: 20, name: "Alexander" },
  { position: 21, name: "Carlos Barbosa Lima" },
  { position: 22, name: "Pedro Pedroso" },
  { position: 23, name: "Renato Zaragoza" },
  { position: 24, name: "Carlão" },
  { position: 25, name: "André Santana" },
  { position: 26, name: "Marcos Alves" },
  { position: 27, name: "Jorge Rodrigues" },
  { position: 28, name: "Paulo Henrique (PH)" },
  { position: 29, name: "Figico" },
  { position: 30, name: "Andrey Figueiredo" },
  { position: 31, name: "Euler Timóteo" },
  { position: 32, name: "Gilberto Damasceno" },
  { position: 33, name: "Célio Assis" },
  { position: 34, name: "Neto" },
  { position: 35, name: "Mário Sérgio" },
  { position: 36, name: "Eric Moeller" },
  { position: 37, name: "Ricardo Brandolt" },
  { position: 38, name: "Ricardo Fló" },
  { position: 39, name: "Rodrigo Giovanetti" },
  { position: 40, name: "Mario Filaretti" },
  { position: 41, name: "Washington Ferri" },
  { position: 42, name: "Fernando Fernandes" },
  { position: 43, name: "Alexandre Rizzato" },
  { position: 44, name: "Roberto Maciel" },
  { position: 45, name: "Luís Emerson" },
  { position: 46, name: "Márcio Papavero" },
  { position: 47, name: "Luciano Machado" },
  { position: 48, name: "Maurício Puschel" },
  { position: 49, name: "Vinícius Di Nucci" },
  { position: 50, name: "Santiago" },
  { position: 51, name: "Chris (Christopher)" },
  { position: 52, name: "Mauro Tomé" },
  { position: 53, name: "Luiz Henrique" },
]
